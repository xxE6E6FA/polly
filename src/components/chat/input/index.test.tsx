...
mock.module("@/hooks/chat-ui/use-chat-input-submission", () => ({
...
mock.module("@/hooks/chat-ui/use-chat-input-image-generation", () => ({
...
mock.module("@/hooks/chat-ui/use-chat-input-drag-drop", () => ({
...
mock.module("@/hooks/chat-ui/use-speech-input", () => ({
