...
export function AnimatedLogo({
  ...
  return (
    ...
    >
      <defs>
        <style>{KEYFRAME_DEFS}</style>
      </defs>

      <g
        style={{
          animation: "logo-breath 7.6s linear infinite",
      ...
      >
        {PATH_SEGMENTS.map(segment => (
          <path key={segment} d={segment} fill="currentColor" />
        ))}
      </g>
    </svg>
  );
