  ...
  const settingsActions = useMemo((): Action[] => {
    ...
    return [
      ...
      },
      {
        ...
        label: "Models",
        icon: RobotIcon,
        handler: () => handleNavigateToSettings(ROUTES.SETTINGS.TEXT_MODELS),
        disabled: !online,
      },
      {
      ...
      },
      {
        ...
        handler: () => handleNavigateToSettings(ROUTES.SETTINGS.HISTORY),
        disabled: !online,
      },
      {
        ...
        label: "Files",
        icon: PaperclipIcon,
        handler: () => handleNavigateToSettings(ROUTES.SETTINGS.FILES),
        disabled: !online,
      },
    ];
