  ...
  return (
    <div className="space-y-2">
      <div className="relative">
        ...
        <Input
          ref={searchInputRef}
          className="h-9 border-0 bg-muted/50 dark:bg-background/80 pl-9 pr-9 text-sm transition-all duration-200 placeholder:text-muted-foreground/60 hover:bg-muted/70 dark:hover:bg-background focus:bg-muted dark:focus:bg-background dark:border dark:border-border/50 focus:outline-none focus:ring-0"
