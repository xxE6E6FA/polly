              ...
              try {
                ...
                const searchResultsMessage = {
                  ...
                  content: `🚨 CRITICAL CITATION REQUIREMENTS 🚨\n\nBased on the user's query, I have searched the web and found relevant information. You MUST cite sources for any information derived from these search results.\n\nSEARCH RESULTS:\n${result.context}\n\nAVAILABLE SOURCES FOR CITATION:\n${result.citations
                    ...
                    .join(
                      "\n"
                    )}\n\n🚨 CITATION PLACEMENT - READ CAREFULLY 🚨\n\nThe PUNCTUATION MARK (period, question mark, exclamation mark) comes FIRST.\nThe CITATION comes SECOND, immediately after.\n\nPattern: word word word PUNCTUATION[citation]\n\n✅ CORRECT EXAMPLES:\n- "The Steam Deck is popular.[1][2]"\n- "Battery life varies by game.[3]"\n- "Is this accurate?[1]"\n- "This is groundbreaking![2][3]"\n\n❌ WRONG - NEVER DO THIS:\n- "The Steam Deck is popular[1][2]." ← WRONG! Citation before period\n- "Battery life varies by game[3]." ← WRONG! Citation before period\n- "Is this accurate[1]?" ← WRONG! Citation before question mark\n\nADDITIONAL RULES:\n- Use ONLY plain square brackets: [1], [2], etc.\n- Group multiple citations: [1][2][3]\n- NO spaces between punctuation and citation\n- NO markdown links like [1](url)\n- NO reference lists at the bottom\n\nRemember: PUNCTUATION FIRST, then [citation]!`,
                };
